...
namespace EvanMod.Content.Projectiles.Melee
{
    public class NightsThrowProjectile : ModProjectile
    {
        ...
        {
            ProjectileID.Sets.YoyosLifeTimeMultiplier[Type] = NightsThrow.SPIN_DURATION_IN_SECONDS;
            ProjectileID.Sets.YoyosMaximumRange[Type] = NightsThrow.REACH_IN_TILES * 16f;
            ProjectileID.Sets.YoyosTopSpeed[Type] = NightsThrow.TOP_VELOCITY_IN_PPI;
        }
